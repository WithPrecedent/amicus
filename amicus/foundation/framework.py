"""
framework: base configuration and file management classes for amicus projects
...
class Distributor(abc.ABC):
    """Core class for amicus FileImporter and FileSaver.
...
class FileFormat(object):
    ...
    Args:
        ...
        module (str): name of module where object to incorporate is located
            (can either be a amicus or non-amicus module).
