...
class Canvas(Book):
    ...
    Args:
        ...
        clerk (Optional[Union['Clerk', str]]): an instance of
            ...
            the amicus package. Defaults to None.
    ...
    def _draft_options(self) -> None:
        self._options = SimpleRepository(contents = {
            'styler': ('amicus.artist.steps.styler', 'Styler'),
            'painter': ('amicus.artist.steps.paint', 'Painter'),
            'animator': ('amicus.artist.steps.animator', 'Animator')}
        return self
