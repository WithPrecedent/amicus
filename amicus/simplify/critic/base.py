...
#             name = 'eli5_explain',
#             module = 'amicus.critic.explainers',
...
#         'eli5': base.SimpleTechnique(
#             name = 'eli5_predict',
#             module = 'amicus.critic.predictors',
...
#     'measure': {
#         'amicus': base.SimpleTechnique(
#             name = 'amicus_measure',
#             module = 'amicus.critic.metrics',
...
#         'amicus': base.SimpleTechnique(
#             name = 'amicus_report',
#             module = 'amicus.critic.reporters',
...
class Evaluator(Technique):
    ...
    Args:
        name (Optional[str]): designates the name of the class used for internal
            ...
            section name in 'Idea'. When subclassing, it is a good idea to use
            the same 'name' attribute as the base class for effective
            coord   ination between amicus classes. 'name' is used instead of
            __class__.__name__ to make such subclassing easier. Defaults to
...
class Critic(Worker):
    ...
    module: Optional[str] = dataclasses.field(
        default_factory = lambda: 'amicus.critic.critic')
