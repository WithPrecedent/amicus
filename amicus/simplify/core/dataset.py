...
class Dataset(amicus.quirks.Needy, amicus.quirks.Element):
    ...
    Args:
        ...
        datatypes (Optional[Dict[str, str]]): keys are column names and values
            are amicus proxy datatypes. Defaults to an empty dictionary.
